    ...
    describe('create', () => {
        it('should retrieve error when creating organization without a unique name', async () => {
            ...
            try {
                ...
                expect(error.message).toEqual('Er bestaat al een bedrijf met de opgegeven naam!')
            }
        });
        ...
        it('should retrieve error when creating organization without a unique emailDomain', async () => {
            ...
            try {
                ...
                expect(error.status).toEqual(400);
                expect(error.message).toEqual('Er bestaat al een bedrijf met het opgegeven email domein!')
            }
        });
